...
class AccountClient:
    ...
    async def add_bitcoin_address(self, params: AddBitcoinAddressParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import AddBitcoinAddressParams
    ...
    async def withdraw_lightning(self, params: WithdrawLightningParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import WithdrawLightningParams
    ...
    async def withdraw_on_chain(self, params: WithdrawOnChainParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import WithdrawOnChainParams
    ...
    async def get_lightning_withdrawals(
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import GetLightningWithdrawalsParams
    ...
    async def get_on_chain_deposits(
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import GetOnChainDepositsParams
    ...
    async def get_on_chain_withdrawals(
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import GetOnChainWithdrawalsParams
    ...
    async def get_notifications(self, params: GetNotificationsParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.account import GetNotificationsParams
