...
from lnmarkets_sdk.rest.v3.models.futures_cross import (
    CancelOrderParams,
    DepositParams,
...
class FuturesCrossClient:
    ...
    async def get_filled_orders(self, params: GetFilledOrdersParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import GetFilledOrdersParams
    ...
    async def cancel(self, params: CancelOrderParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import CancelOrderParams
    ...
    async def deposit(self, params: DepositParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import DepositParams
    ...
    async def withdraw(self, params: WithdrawParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import WithdrawParams
    ...
    async def set_leverage(self, params: SetLeverageParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import SetLeverageParams
    ...
    async def get_transfers(self, params: GetTransfersParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import GetTransfersParams
    ...
    async def get_funding_fees(self, params: GetCrossFundingFeesParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.futures_cross import GetCrossFundingFeesParams
