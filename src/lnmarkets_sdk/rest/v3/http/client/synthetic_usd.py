...
from lnmarkets_sdk.rest.v3.models.synthetic_usd import (
    BestPriceResponse,
    CreateSwapOutput,
    GetSwapsParams,
    NewSwapParams,
...
class SyntheticUSDClient:
    ...
    async def get_swaps(self, params: GetSwapsParams | None = None):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.synthetic_usd import GetSwapsParams
    ...
    async def new_swap(self, params: NewSwapParams):
        ...
        Example:
        ```python
        from lnmarkets_sdk.rest.v3.models.synthetic_usd import NewSwapParams
